...
\copyrightyear{2021} 
\acmYear{2021} 
\setcopyright{acmcopyright}\acmConference[ICPP Workshops '21]{50th International Conference on Parallel Processing Workshop}{August 9--12, 2021}{Lemont, IL, USA}
\acmBooktitle{50th International Conference on Parallel Processing Workshop (ICPP Workshops '21), August 9--12, 2021, Lemont, IL, USA}
\acmPrice{15.00}
\acmDOI{10.1145/3458744.3474050}
\acmISBN{978-1-4503-8441-4/21/08}
...
\keywords{neural networks, multilayer perceptrons, APA matrix multiplication}
...
We also demonstrate up to 15\% improvement when training the fully connected layers of the VGG-19 image classification network.
\end{abstract}
...
\includegraphics[scale=.85]{tikz-taps/paper-figure2.pdf}
...
%\input{plots/matmul_perf}
\includegraphics[scale=.85]{tikz-taps/paper-figure3.pdf}
...
%\input{plots/matmul_perf}
\includegraphics[scale=.85]{tikz-taps/paper-figure4.pdf}
%\caption{Multithreaded matrix multiplication performance (6 threads)}
...
The performance results for 6 threads shows that algorithm $\dims{4,4,2}$ and its variances are still the dominant one among all 12 APA algorithms and their variances.
\end{comment}
...
%\input{plots/NN_acc}
\includegraphics[scale=.9]{tikz-taps/paper-figure5.pdf}
...
%\input{plots/NN_acc}
\includegraphics[scale=.9]{tikz-taps/paper-figure6.pdf}
...
Figure~\ref{fig:NN_acc_train} plots the accuracy on the training data over each epoch, and Fig.~\ref{fig:NN_acc_test} shows the test accuracy over epochs. 
...
\includegraphics[scale=.85]{tikz-taps/paper-figure8.pdf}
...
\renewcommand{\threads}{6}
%\input{plots/NN_reltime}
\includegraphics[scale=.85]{tikz-taps/paper-figure9.pdf}
...
\renewcommand{\threads}{12}
%\input{plots/NN_reltime}
\includegraphics[scale=.85]{tikz-taps/paper-figure10.pdf}
...
\subfloat[One thread]{
\centering
%\input{plots/VGG_time_seq}
\includegraphics[scale=1.75]{tikz-taps/paper-figure11.pdf}
\label{fig:vgg_seq}}%
\hfill	
\subfloat[Six threads]{
\centering
%\input{plots/VGG_time}
\includegraphics[scale=1.75]{tikz-taps/paper-figure12.pdf}
\label{fig:vgg_par6}}
%
