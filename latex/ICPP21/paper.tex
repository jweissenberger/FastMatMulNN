...
\includegraphics{tikz-taps/paper-figure2.pdf}
...
%\input{plots/matmul_perf}
\includegraphics{tikz-taps/paper-figure3.pdf}
...
%\input{plots/matmul_perf}
\includegraphics{tikz-taps/paper-figure4.pdf}
%\caption{Multithreaded matrix multiplication performance (6 threads)}
...
%\input{plots/NN_acc}
\includegraphics{tikz-taps/paper-figure5.pdf}
...
%\input{plots/NN_acc}
\includegraphics{tikz-taps/paper-figure6.pdf}
...
\includegraphics{tikz-taps/paper-figure8.pdf}
...
\renewcommand{\threads}{6}
%\input{plots/NN_reltime}
\includegraphics{tikz-taps/paper-figure9.pdf}
...
\renewcommand{\threads}{12}
%\input{plots/NN_reltime}
\includegraphics{tikz-taps/paper-figure10.pdf}
...
\includegraphics{tikz-taps/paper-figure11.pdf}
\label{fig:vgg_seq}}%
\hfill	
\subfloat[Six threads]{
\centering
%\input{plots/VGG_time}
\includegraphics{tikz-taps/paper-figure12.pdf}
\label{fig:vgg_par6}}
%
