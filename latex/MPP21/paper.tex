...
\GB{add paragraph describing householder, listing versions of MKL, peak GFLOPS}
...
\begin{enumerate}
	\item describe network (MLP for MNIST) and implementation details (including TensorFlow with version number)
