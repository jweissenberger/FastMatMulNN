...
Training is performed using batched stochastic gradient descent with a batch size of \GB{ZZZ}.
APA algorithms were used for the middle multiplication of the network (yielding matrix multiplication dimenions $300\times \GB{ZZZ}\times300$), while the input and output layers use the classical matrix multiplication algorithm. 
