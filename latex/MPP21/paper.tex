...
\JW{Open-AI's most recent language model, GPT-3, spent the equivalent of days training on a petaflop machine. Even a slight reduction in flops could save a large amount of time and reduce server costs.}\cite{BM+20}
