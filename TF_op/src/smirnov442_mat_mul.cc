...
#include "linalg.hpp"
#include "smirnov442_24_180_approx.hpp"

using namespace tensorflow;

REGISTER_OP("FastMatMul442")
    .Attr("epsilon: float")
    .Attr("steps: int")
    .Attr("numthreads: int")
...
public:
    ...
    void Compute(OpKernelContext* context) override {
        ...
        // call smirnov442's matmul
        smirnov442_24_180_approx::FastMatmul(A, B, C, numsteps_, epsilon_, numthreads_);
...
REGISTER_KERNEL_BUILDER(Name("FastMatMul442").Device(DEVICE_CPU), FastMatMulOp);
