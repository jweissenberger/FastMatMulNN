...
#include "linalg.hpp"
#include "smirnov424_24_180_approx.hpp"

using namespace tensorflow;

REGISTER_OP("FastMatMul424")
    .Attr("epsilon: float")
    .Attr("steps: int")
    .Attr("numthreads: int")
...
public:
    ...
    void Compute(OpKernelContext* context) override {
        ...
        // call smirnov424's matmul
        smirnov424_24_180_approx::FastMatmul(A, B, C, numsteps_, epsilon_, numthreads_);
