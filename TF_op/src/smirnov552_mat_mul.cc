...
#include "linalg.hpp"
#include "smirnov552_37_262_approx.hpp"

using namespace tensorflow;

REGISTER_OP("FastMatMul552")
    .Attr("epsilon: float")
    .Attr("steps: int")
    .Attr("numthreads: int")
...
public:
    ...
    void Compute(OpKernelContext* context) override {
        ...
        // call smirnov552's matmul
        smirnov552_37_262_approx::FastMatmul(A, B, C, numsteps_, epsilon_, numthreads_);
...
REGISTER_KERNEL_BUILDER(Name("FastMatMul552").Device(DEVICE_CPU), FastMatMulOp);
