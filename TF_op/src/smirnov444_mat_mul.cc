...
public:
    ...
    void Compute(OpKernelContext* context) override {
        ...
        smirnov444_46_352_approx::FastMatmul(A, B, C, numsteps_, epsilon_, numthreads_);
...
REGISTER_KERNEL_BUILDER(Name("FastMatMul444").Device(DEVICE_CPU), FastMatMulOp);
