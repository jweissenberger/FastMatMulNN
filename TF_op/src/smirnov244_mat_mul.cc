...
#include "linalg.hpp"
#include "smirnov244_24_180_approx.hpp"

using namespace tensorflow;

REGISTER_OP("FastMatMul244")
    .Attr("epsilon: float")
    .Attr("steps: int")
    .Attr("numthreads: int")
...
public:
    ...
    void Compute(OpKernelContext* context) override {
        ...
        // call smirnov244's matmul
        smirnov244_24_180_approx::FastMatmul(A, B, C, numsteps_, epsilon_, numthreads_);
...
REGISTER_KERNEL_BUILDER(Name("FastMatMul244").Device(DEVICE_CPU), FastMatMulOp);
