...
#include "linalg.hpp"
#include "smirnov242_13_91_approx.hpp"

using namespace tensorflow;

REGISTER_OP("FastMatMul242")
    .Attr("epsilon: float")
    .Attr("steps: int")
    .Attr("numthreads: int")
...
public:
    ...
    void Compute(OpKernelContext* context) override {
        ...
        // call smirnov242's matmul
        smirnov242_13_91_approx::FastMatmul(A, B, C, numsteps_, epsilon_, numthreads_);
...
REGISTER_KERNEL_BUILDER(Name("FastMatMul242").Device(DEVICE_CPU), FastMatMulOp);
